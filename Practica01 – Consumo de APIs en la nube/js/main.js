...
function getsource(id) {
    $.ajax({
        url: "https://api.spoonacular.com/recipes/"+id+"/information?apiKey=c4c96f58049e4dc89f038e2503edee89",
    ...
    function getrecepe(q){
        $.ajax({
            url: "https://api.spoonacular.com/recipes/search?apiKey=c4c96f58049e4dc89f038e2503edee89&number=1&query="+q,
            success: function(res){
                document.getElementById("output").innerHTML="<h1>"+res.results[0].title+"</h1><br><img src='"+res.baseUri+res.results[0].image+"' width='400'/>+<br>"+res.results[0].readyInMinutes+"minutes"
